...
add_action( 'cmb2_admin_init', 'onramp_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function onramp_register_demo_metabox()
{
    $prefix = 'onramp_demo_';
    ...
    $cmb_demo = new_cmb2_box( array(
        ...
        // 'show_on_cb' => 'onramp_show_if_front_page', // function should return a bool value
        // 'context'    => 'normal',
        // 'priority'   => 'high',
        ...
        // 'classes_cb' => 'onramp_add_some_classes', // Add classes through a callback.
    ) );
    ...
    $cmb_demo->add_field( array(
        ...
        'id'         => $prefix . 'text',
        'type'       => 'text',
        'show_on_cb' => 'onramp_hide_if_no_cats', // function should return a bool value
    ...
    $cmb_demo->add_field( array(
        ...
        // );
        // 'display_cb' => 'onramp_display_text_small_column', // Output the display of the column values through a callback.
    ) );
    ...
    $cmb_demo->add_field( array(
        ...
        'type' => 'text',
        'render_row_cb' => 'onramp_render_row_cb',
    ) );
    ...
    $cmb_demo->add_field( array(
        ...
        'type'         => 'text',
        'before_row'   => 'onramp_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'onramp_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function onramp_register_about_page_metabox()
{
    $prefix = 'onramp_about_';
...
add_action( 'cmb2_init', 'onramp_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function onramp_register_repeatable_group_field_metabox()
{
    $prefix = 'onramp_group_rest_';
...
add_action( 'cmb2_admin_init', 'onramp_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function onramp_register_user_profile_metabox()
{
    $prefix = 'onramp_user_';
...
add_action( 'cmb2_admin_init', 'onramp_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function onramp_register_taxonomy_metabox()
{
    $prefix = 'onramp_term_';
...
add_action( 'cmb2_admin_init', 'onramp_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function onramp_register_theme_options_metabox()
{
    ...
    $cmb_options = new_cmb2_box( array(
        ...
        'option_key'      => 'onramp_theme_options', // The option key and admin menu page slug.
...
add_action( 'cmb2_init', 'onramp_register_rest_api_box' );
/**
 ...
 */
function onramp_register_rest_api_box()
{
    $prefix = 'onramp_rest_';
    ...
    $cmb_rest = new_cmb2_box( array(
        ...
        // 'get_box_permissions_check_cb' => 'onramp_limit_rest_view_to_logged_in_users',
    ) );
